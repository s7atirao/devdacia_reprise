...
<body dir="<?php print $direction ?>">
    <div class="lp-quizz">
        <nav>
            <h1 class="logo">
                <a title="Dacia succursale" href="https://www.succursalesdacia.ma/">
            ...
            <div class="main-head">
                <div class="classlag">
                    <span>
                        <a class="classfr" href="?lang=fr" title="francais">FR</a>
                    </span>/
                    <span>
                      <a class="" href="?lang=ar">AR</a>
                  </span>
              </div>
              <span class="sslogan"><a href="https://www.succursalesdacia.ma/"><?php print $langue["les succursales Dacia"]?></a></span>
          </div>
      </nav>
